...
export const planejamentoService = { metas: () => api.get('/planejamento/metas'), criarMeta: (dados) => api.post('/planejamento/metas', dados), atualizarMeta: (id,dados) => api.put(`/planejamento/metas/${id}`, dados), excluirMeta: (id) => api.delete(`/planejamento/metas/${id}`), simular: (dados) => api.post('/planejamento/simulacoes', dados), resumo: () => api.get('/planejamento/resumo') }
